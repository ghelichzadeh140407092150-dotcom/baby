...
import 'package:flutter_riverpod/flutter_rivermod';
...
class MonetizationScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(l10n.monetization, style: theme.textStyles.h2),
