// test/features/child/presentation/export/export_data_screen_test.dart
...
import 'package:hamrah_madaran/features/child/presentation/export/export_data_screen.dart';
...
void main() {
  ...
  group('ExportDataScreen', () {
    ...
    testWidgets('has app bar title', (tester) async {
      ...
      expect(find.text(' صادرات داده‌ها'), findsOneWidget);
    });
  });
}