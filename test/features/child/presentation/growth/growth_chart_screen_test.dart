// test/features/child/presentation/growth/growth_chart_screen_test.dart
...
import 'package:hamrah_madaran/features/child/presentation/growth/growth_chart_screen.dart';
...
void main() {
  ...
  group('GrowthChartScreen', () {
    ...
    testWidgets('has app bar title', (tester) async {
      ...
      expect(find.text(' نمو کودک'), findsOneWidget);
    });
  });
}