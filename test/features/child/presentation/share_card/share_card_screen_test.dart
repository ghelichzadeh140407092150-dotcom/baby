// test/features/child/presentation/share_card/share_card_screen_test.dart
...
import 'package:hamrah_madaran/features/child/presentation/share_card/share_card_screen.dart';
...
void main() {
  ...
  group('ShareCardScreen', () {
    ...
    testWidgets('has app bar title', (tester) async {
      ...
      expect(find.text('شماره اشتراک'), findsOneWidget);
    });
  });
}